...
<br><br>
      ...
      <th>Tipo</th>
        ...
        <td>
          ...
          else if($user->kind==2){ echo "Secretaria"; }
          else if($user->kind==3){ echo "Bioanalista"; }
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <select name="kind" class="form-control" required>
        <option value="3">Bioanalista</option>
...
<p class="help-block">La contrase&ntilde;a solo se modificara si escribes algo, en caso contrario no se modifica.</p>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <select name="kind" class="form-control" required>
        <option value="3" <?php if($user->kind==3){ echo "selected"; } ?>>Bioanalista</option>
        <option value="2" <?php if($user->kind==2){ echo "selected"; } ?>>Secretaria</option>
